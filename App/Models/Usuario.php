...
class Usuario extends Model {
  ...
  public function autenticar() {
	...
	public function getTotalSeguindo() {
		$query = 'select count(*) as totalSeguindo from usuarios_seguidores where id_usuario = :id_usuario and id_usuario_seguindo != :id_usuario';
		$stmt = $this->db->prepare($query);
		$stmt->bindValue(':id_usuario', $this->__get('id_usuario'));
		$stmt->execute();
		return $stmt->fetch(\PDO::FETCH_ASSOC);
	...
	public function validaUser() {
		$query = 'delete usuarios_seguidores
		from usuarios_seguidores
		left join usuarios on usuarios_seguidores.id_usuario_seguindo = usuarios.id
		where 
		usuarios.id is null
		';
	}
	...
	public function getTotalTweets() {
		$query = 'select count(*) as ttweets from tweets as t
